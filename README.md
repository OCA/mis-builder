...
the 12.0 branch, to be forward-ported to 13.0. Please submit pull requests to the 12.0
branch in priority, unless they are 13.0 specific bugs, or they rely on
Odoo features that are not present in 12.0.**
...
--- | --- | ---
[mis_builder](mis_builder/) | 13.0.3.6.2 | Build 'Management Information System' Reports and Dashboards
