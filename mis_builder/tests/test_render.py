...
class TestRendering(common.TransactionCase):
    ...
    def test_render_mon(self):
        self.assertEquals(u'1.00\xa0€', self._render_mon(1))
        self.assertEquals(u'1.10\xa0€', self._render_mon(1.1))
        self.assertEquals(u'1.60\xa0€', self._render(1.604))
        self.assertEquals(u'1.61\xa0€', self._render(1.606))
        self.assertEquals(u"12'345.67\xa0€", self._render(12345.67))
