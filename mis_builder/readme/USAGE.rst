...
given KPI can display multiple columns (eg: Initial balance, Debit, Credit and
Ending Balance).
...
NB: When the report is displayed in the web interface user can click on any figure and drill down to the underlying data.
